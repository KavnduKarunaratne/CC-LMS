    ...
    <div class="container mx-auto py-8 mt-12">
        ...
        <form class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md" method="post" action="{{ route('update-feedback', ['id' => $feedback->id]) }}">
            ...
            <div class="mb-4">
                ...
                <textarea type="text" name="feedback" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"></textarea>
            </div>
           ...
           <div class="mb-4">
            ...
            <select name="submission_id" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none">
                ...
                <option value="{{$submission->id}}">{{$submission->submission_name}}</option>
                @endforeach
                </select>
            </div>
