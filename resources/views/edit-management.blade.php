...
<div class="container mx-auto py-8 mt-12">
    ...
    <form method="post" action="{{ route('update-management', ['id' => $management->id]) }}" class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ $management->name }}" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"/>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Email</label>
            <input type="email" name="email" value="{{ $management->email }}" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"/>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="admission_number">Admission</label>
            <input type="text" name="admission_number" value="{{ $management->admission_number }}" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"/>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="year_of_registration" value="{{ $management->year_of_registration }}" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-300 focus:bg-white focus:outline-none"/>
        </div>
