      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-indigo-600 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="w-5 h-5 text-indigo-600 transition duration-75 dark:text- group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
...
<div class="bg-white py-5 mb-0">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-semi-bold text-gray-900 mb-8">Welcome to Student Panel</h2>
...
<div class="bg-white py-5 mb-0">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-semi-bold text-gray-900 mb-8">Your Subjects</h2>
        <div class="grid grid-cols-1 md:grid-cols-1 gap-8">
