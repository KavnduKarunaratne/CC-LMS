...
<nav
  class="flex-no-wrap relative flex w-full items-center justify-between bg-white dark:bg-black py-2  lg:flex-wrap lg:justify-start ">
  <div class="flex w-full flex-wrap items-center justify-between px-3 ">
    ...
    <div class="relative flex items-center">
      ...
      <div
        ...
        <p
          class="dark:text-white text-black hidden-arrow flex items-center whitespace-nowrap transition duration-150 ease-in-out motion-reduce:transition-none"
