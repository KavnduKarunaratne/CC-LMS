...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-4 font-medium">
         <li class>
            <a href="#" class="flex items-center p-2 text-gray-900 hover:text-black rounded-lg dark:text-white bg-indigo-300 dark:hover:bg-gray-700 group">
         ...
         {{--<li>
            <a href="{{ route('view-my-submissions') }}" class="flex items-center p-2 text-pink-600 rounded-lg dark:text-white bg-pink-300 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('view-my-submissions') }}" class="flex items-center p-2 text-pink-500 rounded-lg dark:text-white bg-pink-200 dark:hover:bg-gray-700 group">
...
<div class="p-4 sm:ml-64">
   ...
   <div class="columns-2">
   <div class=""><img class="h-[400px]" src="images/bookmonster.png"></div>
   <div>
   @include('kiddyLMS.speechbubble')
   </div>
