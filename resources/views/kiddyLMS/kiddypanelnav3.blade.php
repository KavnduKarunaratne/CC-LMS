...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         <li class>
            <a href="#" class="flex items-center p-2 text-indigo-600 hover:text-black rounded-lg dark:text-white hover:bg-indigo-300 dark:hover:bg-gray-700 group">
               <svg class="w-10 h-10 text-indigo-600 transition duration-75 dark:text- group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         {{--<li>
            <a href="{{ route('view-my-submissions') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-pink-300 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-10 h-10 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
         ...
         <li>
            <a href="{{ route('view-my-submissions') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-pink-200 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ url('profile/show') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-green-200 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="{{ route('logout') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-yellow-200 dark:hover:bg-gray-700 group">
...
<div class="image-container">
  ...
  <img src="images/cloudbg.png" alt="Image 1" class=" move-left1">
...
<style>
  ...
  .move-left {
    animation-name: moveLeft;
    animation-duration: 15s; /* Adjust the animation duration for slower movement */
  }
